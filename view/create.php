...
<head>
    ...
    <title>Halaman Tambah Murid</title>
...
<body>
    ...
    <div class="card-form col-lg-4 col-sm-9 m-auto shadow-sm bg-white">
        <h1 class="p-3 text-center fw-bold">Form Add Data</h1>
        <form action="web.php?action=create" method="post" class="p-3">
            <div class="input-box row mb-3">
                ...
                <div class="col">
                    ...
                    <input type="text" name="nama_belakang" id="nama_belakang" placeholder="Last Name (Optional)"
                        class="form-control border-secondary" autocomplete="off">
                </div>
            </div>
            <div class="input-box mb-3">
                <label for="nis" class="form-label">NIS :</label>
                <input type="text" name="nis" id="nis" placeholder="Student Indetification Number (SIN)" class="form-control border-secondary" required autocomplete="off">
            </div>
            <div class="input-box mb-3">
            ...
            <div class="input-box mb-3">
                ...
                <input type="text" name="kelas" id="kelas" placeholder="Your Class" class="form-control border-secondary" required autocomplete="off">
            </div>
            <div class="input-box mb-3">
                ...
                <select name="jurusan_id" id="jurusan_id" class="form-select border-secondary" required>
                    ...
                    <option value="2">Teknik Kendaraan Ringan Otomotif</option>
                    <option value="3">Akuntansi</option>
                    <option value="4">Administrasi Perkantoran</option>
                </select>
            </div>
            <div class="input-box mb-3">
                <button type="submit" class="btn btn-lg btn-primary w-100 text-white">Add <i class="fas fa-plus"></i></button>
                <a href="../public/web.php" class="btn btn-lg btn-danger mt-2 w-100 text-white">Back <i class="fas fa-arrow-right-from-bracket"></i></a>
            </div>
        </form>
    </div>
    </div>
